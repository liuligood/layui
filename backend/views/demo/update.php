    ...
    <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="required" value="<?=$info['title']?>" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="desc" lay-verify="required" value="<?=$info['desc']?>" placeholder="请输入备注" class="layui-input ">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-upload ys-upload-img-multiple" data-number="10">
                    ...
                    <input type="hidden" name="goods_img" class="layui-input" value="<?=empty($info['goods_img'])?'[]':htmlentities($info['goods_img'], ENT_COMPAT);?>">
